    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal">
                    ...
                    <div class="panel-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <select class="expanded-input" id="tinh-trang-thanh-toan" name="tinh-trang-thanh-toan">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <select class="expanded-input" id="tinh-trang-don-hang" name="tinh-trang-don-hang">
                ...
                <button type="submit" class="btn btn-primary btn-lg center-block">Thay đổi thông tin</button>
                <hr>
            </form>
        </div>
    </div>
